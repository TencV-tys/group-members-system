        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($members as $member)
                    <div class="bg-white border rounded-xl overflow-hidden hover:shadow-2xl transition duration-300 transform hover:-translate-y-1">
                        <!-- Profile Photo Section -->
                        <div class="h-48 bg-linear-to-r from-blue-400 to-blue-600 flex items-center justify-center relative">
                            ...
                            @else
                                <div class="w-32 h-32 rounded-full bg-gray-300 border-4 border-white absolute -bottom-16 shadow-lg flex items-center justify-center">
                        ...
                        <!-- Member Info Section -->
                        <div class="pt-20 p-6 text-center">
                            ...
                            <div class="flex items-center justify-center text-gray-600 mb-4">
                                ...
                                <span class="text-lg">{{ $member->age }} years old</span>
                            </div>
